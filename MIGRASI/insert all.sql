...
FROM 
	(
		SELECT  '00' KDHUBKEL, A.NOTAS, A.NIP, A.NO_KPE, A.NAMA, A.JNSKEL, A.TGLLHR, A.TMT_KERJA, A.TMT_TASPEN, A.TGLWAFAT, A.TGLPMK, A.KDKELOMPOK, A.KDJNSPEG, A.KDPANGKAT, A.MASKER, A.KDKEDUDUKAN, A.BUP, A.GAPOK, 
		...
		FROM  
			(
				...
				,A.NIP
				,A.NO_KPE
				,(SELECT REPLACE(REPLACE(TRIM(CHAR(160) FROM NMKEL),'\T',''),'N','')  FROM  KELUARGA Z WHERE Z.NOTAS=A.NOTAS AND Z.KDHUBKEL='00') NAMA
				,(SELECT Z.JENKEL FROM  KELUARGA Z WHERE Z.NOTAS=A.NOTAS AND Z.KDHUBKEL='00') JNSKEL
				,(SELECT Z.TGLLHR FROM  KELUARGA Z WHERE Z.NOTAS=A.NOTAS AND Z.KDHUBKEL='00') TGLLHR
				,A.TMT_KERJA
				,A.TMT_TASPEN
				,(SELECT Z.TGLWAFAT FROM  KELUARGA Z WHERE Z.NOTAS=A.NOTAS AND Z.KDHUBKEL='00') TGLWAFAT
				,A.TGLPMK
				,(SELECT W.KDKELOMPOK FROM  MUTASI_HIST W 			WHERE W.NOTAS=A.NOTAS  AND W.TMT_MUTASI =(SELECT MAX(G.TMT_MUTASI)FROM MUTASI_HIST G WHERE G.NOTAS=W.NOTAS )) KDKELOMPOK
				,(SELECT W.KDJENPEG 		FROM  MUTASI_HIST W			WHERE W.NOTAS=A.NOTAS  AND W.TMT_MUTASI =(SELECT MAX(G.TMT_MUTASI)FROM MUTASI_HIST G WHERE G.NOTAS=W.NOTAS )) KDJNSPEG
				,(SELECT W.KDPANGKAT 	FROM  MUTASI_HIST W			WHERE W.NOTAS=A.NOTAS  AND W.TMT_MUTASI =(SELECT MAX(G.TMT_MUTASI)FROM MUTASI_HIST G WHERE G.NOTAS=W.NOTAS )) KDPANGKAT
				,(SELECT W.MASKER 			FROM  MUTASI_HIST W			WHERE W.NOTAS=A.NOTAS  AND W.TMT_MUTASI =(SELECT MAX(G.TMT_MUTASI)FROM MUTASI_HIST G WHERE G.NOTAS=W.NOTAS )) MASKER
				,(SELECT W.KDDUDUKAN 	FROM  MUTASI_HIST W			WHERE W.NOTAS=A.NOTAS  AND W.TMT_MUTASI =(SELECT MAX(G.TMT_MUTASI)FROM MUTASI_HIST G WHERE G.NOTAS=W.NOTAS )) KDKEDUDUKAN
				,(SELECT N.BUP_MAX  			FROM  KEDUDUKAN_TBL N 	WHERE N.KDDUDUKAN=(SELECT W.KDDUDUKAN FROM  MUTASI_HIST W WHERE W.NOTAS=A.NOTAS  AND W.TMT_MUTASI =(SELECT MAX(G.TMT_MUTASI)FROM MUTASI_HIST G WHERE G.NOTAS=W.NOTAS ))) BUP
				,(SELECT W.GAPOK 				FROM  MUTASI_HIST W 			WHERE W.NOTAS=A.NOTAS  AND W.TMT_MUTASI =(SELECT MAX(G.TMT_MUTASI)FROM MUTASI_HIST G WHERE G.NOTAS=W.NOTAS )) GAPOK
				,NULL GAPOK97
				,(SELECT W.KDSTAPEG 			FROM  MUTASI_HIST W 		WHERE W.NOTAS=A.NOTAS  AND W.TMT_MUTASI =(SELECT MAX(G.TMT_MUTASI)FROM MUTASI_HIST G WHERE G.NOTAS=W.NOTAS )) KDSTAPEG
				,(SELECT W.PERSENGAPOK 	FROM  MUTASI_HIST W 		WHERE W.NOTAS=A.NOTAS  AND W.TMT_MUTASI =(SELECT MAX(G.TMT_MUTASI)FROM MUTASI_HIST G WHERE G.NOTAS=W.NOTAS )) PERSENGAPOK
				,(SELECT W.TMT_GAPOK 		FROM  MUTASI_HIST W 		WHERE W.NOTAS=A.NOTAS  AND W.TMT_MUTASI =(SELECT MAX(G.TMT_MUTASI)FROM MUTASI_HIST G WHERE G.NOTAS=W.NOTAS )) TMT_GAPOK
				,NULL TMT_GAPOK_TBL
				,(SELECT P.KDJIWA 					FROM  THP_HIST P 				WHERE P.NOTAS=A.NOTAS AND P.TMT_THP= (SELECT MAX(Y.TMT_THP)  FROM  THP_HIST Y WHERE Y.NOTAS=P.NOTAS)) KDJIWA_AKTIF
				,(SELECT P.NILAI_THP 				FROM  THP_HIST P 				WHERE P.NOTAS=A.NOTAS AND P.TMT_THP= (SELECT MAX(Y.TMT_THP)  FROM  THP_HIST Y WHERE Y.NOTAS=P.NOTAS))NILAI_THP
				,NULL NILAI_THP_97
				,A.BLTHGAJI
				,(SELECT MAX(Q.KDREG) 																		FROM  REGISTRASI Q 			WHERE Q.NOTAS=A.NOTAS AND Q.KDHUBKEL='00' AND Q.TGLREG =(SELECT MAX(U.TGLREG) FROM REGISTRASI U WHERE U.NOTAS=Q.NOTAS)) KDREG
				,(SELECT MAX(Q.TGLREG) 																		FROM  REGISTRASI Q 			WHERE Q.NOTAS=A.NOTAS AND Q.KDHUBKEL='00' AND Q.TGLREG =(SELECT MAX(U.TGLREG) FROM REGISTRASI U WHERE U.NOTAS=Q.NOTAS)) TGLREG
				,(SELECT MAX(Q.NOREG)  																		FROM  REGISTRASI Q 			WHERE Q.NOTAS=A.NOTAS AND Q.KDHUBKEL='00' AND Q.TGLREG =(SELECT MAX(U.TGLREG) FROM REGISTRASI U WHERE U.NOTAS=Q.NOTAS)) NOREG
				,(SELECT W.KDSATKER 																				FROM  MUTASI_HIST W 		WHERE W.NOTAS=A.NOTAS  AND W.TMT_MUTASI =(SELECT MAX(G.TMT_MUTASI)FROM MUTASI_HIST G WHERE G.NOTAS=W.NOTAS )) KDSATKER
				,(SELECT R.ALM_PESERTA 																	FROM  ALAMAT_HIST R 		WHERE R.NOTAS=A.NOTAS AND R.KDHUBKEL='00' AND R.TMT_ALM=(SELECT MAX(N.TMT_ALM) FROM ALAMAT_HIST N WHERE N.NOTAS=R.NOTAS)) ALAMAT
				,(SELECT MAX(R.KDDATI1||R.KDDATI2||R.KDDATI3||R.KDDATI4)  FROM  ALAMAT_HIST R 		WHERE R.NOTAS=A.NOTAS AND R.KDHUBKEL='00' AND  R.TMT_ALM=(SELECT MAX(N.TMT_ALM) FROM ALAMAT_HIST N WHERE N.NOTAS=R.NOTAS)) LOKASI_ALAMAT
				,(SELECT MAX(T.NOCROSSDEF) 															FROM  CROSSDEFAULT T 	WHERE T.NOTAS=A.NOTAS  AND T.UPDSTAMP=(SELECT MAX(J.UPDSTAMP) FROM CROSSDEFAULT J WHERE J.NOTAS=T.NOTAS)) NOCROSSDEF
				,(SELECT MAX(U.JNSUZUR) 																	FROM  HAK_UZUR U 			WHERE U.NOTAS=A.NOTAS AND U.KDHUBKEL='00' AND U.UPDSTAMP=(SELECT MAX(J.UPDSTAMP) FROM CROSSDEFAULT J WHERE J.NOTAS=U.NOTAS) ) JNSUZUR
				,(SELECT TRIM(Z.KTPNO) 																		FROM  KELUARGA Z  			WHERE Z.NOTAS=A.NOTAS AND Z.KDHUBKEL='00')NIK
				,A.NPWP
				,(SELECT W.KDDOKUMEN 																		FROM  MUTASI_HIST W		WHERE W.NOTAS=A.NOTAS  AND W.TMT_MUTASI =(SELECT MAX(G.TMT_MUTASI)FROM MUTASI_HIST G WHERE G.NOTAS=W.NOTAS )) KDDOKUMEN
				,(SELECT W.KETERANGAN 																		FROM  MUTASI_HIST W		WHERE W.NOTAS=A.NOTAS  AND W.TMT_MUTASI =(SELECT MAX(G.TMT_MUTASI)FROM MUTASI_HIST G WHERE G.NOTAS=W.NOTAS )) KETERANGAN
...
--KOREKSI_JKK LEWAT
--PESERTA LEWAT
--PESERTA_CUTOFF LEWAT
--REKAP_SPP LEWAT
select * from taspen.rekap_spp
;
...
INSERT INTO TSPNMIG.TANDAJASA_HIST(TGLWAFAT, KDKELOMPOK, KDHUBKEL, NOTAS, KDTNDJASA, TERUSAN, KDSTOP, TMT_STOP, INPUTER, UPDSTAMP, TMT_TNDJASA, TGLSURAT, NOSURAT, PENERBIT_SURAT, NOPB, TGLPB) SELECT TGL_WAFAT, KDKELOMPOK, KDHUBKEL, TRIM(NOTAS), KDTNDJASA, TERUSAN, KDSTOP, TMT_STOP, INPUTER, UPDSTAMP, TMT_TNDJASA, TGL_SURAT, NO_SURAT, PENERBIT_SURAT, NO_PB, TGL_PB FROM MIG_ACB.TANDAJASA_HIST;
INSERT INTO TSPNMIG.REKAP_REKPASIF(KDCABANG, TGLKEGIATAN, CALON_STOP, RP_CALON, AKTIF, RP_AKTIF, STOP, RP_STOP, INPUTER, TGLAPPROVAL, TGLSTOP, TGLDAPEM, UPDSTAMP) SELECT KDCABANG, TGLKEGIATAN, CALON_STOP, RP_CALON, AKTIF, RP_AKTIF, STOP, RP_STOP, INPUTER, TGLAPPROVAL, TGLSTOP, TGLDAPEM,current_date FROM MIG_ACB.REKAPREKPASIF;
...
FROM MIG_ACB.KLAIM_PENSIUN A INNER JOIN  MIG_ACB.KLAIM_FLOW B ON A.NOTAS=B.NOTAS AND A.TGLKLAIM=B.TGLKLAIM AND A.KDHUBKEL =B.KDHUBKEL
...
INSERT INTO TSPNMIG.TRANS_DOSIR(KDSTATUS, KDCABANG, NODOSIR, KDHUBKEL, NOTAS, TMT_TRANSDOSIR, STS_DOSIR, PEMAKAI, KETERANGAN, PETUGAS_DOSIR, ATASAN_PEMAKAI, UPDSTAMP, INPUTER, TGLKEMBALI, TGLPINJAM) SELECT 1,A.KDCABANG, NODOSIR, A.KDHUBKEL, TRIM(A.NOTAS), TMT_TRANSDOSIR, STS_DOSIR, PEMAKAI, KETERANGAN, PETUGASDOSIR, ATASANPEMAKAI, CURRENT_DATE,'MIGRASI NCB',NULL,NULL FROM MIG_ACB.DOSIR_TRANS A INNER JOIN TSPNMIG.PESERTA AS B ON TRIM(A.NOTAS)=B.NOTAS ;
...
--CABANG
INSERT INTO TSPNMIG.REKAP_LKO_CABANG(TMT_AWAL, TMT_AKHIR, TGLTRANSAKSI, NOMOR, KDCABANG, NAMACABANG, TYPECABANG, GRUPCABANG, KLIM, BUP, PERSENTASE, NILAI, RANKING, KDPRODUK, KDKLAIM, UPDSTAMP, INPUTER) SELECT TMT_AWAL, TMT_AKHIR, TGLTRANSAKSI, NO, A.KDCABANG, NAMACABANG, TYPECABANG, GRUPCABANG, KLIM, BUP, PERSENTASE, NILAI, RANKING, KDPRODUK, KDKLAIM,CURRENT_DATE,'MIGRASI NCB' FROM MIG_ACB.REKAP_LKOCABANG AS A INNER JOIN TSPNMIG.REF_CABANG B ON A.KDCABANG = B.KDCABANG;
INSERT INTO TSPNMIG.GAJI_RAPEL(NIP, NAMA, TGLAHIR, KDSEX, ISTRI, ANAK, KDGOL, GAPOK, IURAN_JKK, IURAN_JKM, IURAN_THT, IURAN_PENS, JMLBULAN, TMT_RAPEL, TAT_RAPEL, BLTHGAJI, JNSGAJI, KODESATKER, KDSSBP, KELSSBP, KDCABANG, FILLER, KDDATI1, KDDATI2, KDKELOMPOK, KDSTAPEG, KDDUDUKAN, INPUTER, TUNJ_ISTRI, TUNJ_ANAK, TPP, TUNJ_ESELON, TUNJ_FUNGSIONAL, TUNJ_GURU, TUNJ_LANGKA, TKD, TUNJ_TERPENCIL, TUNJ_KHUSUS, TUNJ_PAJAK, TUNJ_ASKES, TUNJ_BERAS, TUNJ_UMUM, PEMBULATAN, PENGHASILAN_KOTOR, JMLBERSIH, POT_IWP, PERSENGAPOK, KD_ESELON, KD_FUNGSIONAL, KDGURU, TMT_BERLAKU) SELECT NIP, NAMA, TGLAHIR, KDSEX, ISTRI, ANAK, KDGOL, GAPOK, IURAN_JKK, IURAN_JKM, IURAN_THT, IURAN_PENS, JMLBULAN, TMT_RAPEL, TAT_RAPEL, BLTHGAJI, JNSGAJI, KODESATKER, KDSSBP, KELSSBP, A.KDCABANG, FILLER, A.KDDATI1, A.KDDATI2, KDKELOMPOK, KDSTAPEG, KDDUDUKAN, INPUTER, TUNJ_ISTRI, TUNJ_ANAK, TPP, TUNJ_ESELON, TUNJ_FUNGSIONAL, TUNJ_GURU, TUNJ_LANGKA, TKD, TUNJ_TERPENCIL, TUNJ_KHUSUS, TUNJ_PAJAK, TUNJ_ASKES, TUNJ_BERAS, TUNJ_UMUM, PEMBULATAN, PENGHASILAN_KOTOR, JMLBERSIH, POT_IWP, PERSENGAPOK, KD_ESELON, KD_FUNGSIONAL, KDGURU, TMT_BERLAKU FROM MIG_ACB.GAJIRAPEL A INNER JOIN TSPNMIG.REF_CABANG B ON A.KDCABANG = B.KDCABANG;
...
INSERT INTO TSPNMIG.ALAMAT_HIST(TMT_ALM, KDHUBKEL, NOTAS, ALAMAT, KOTA, KDPOS, TELEPON, KDDATI1, KDDATI2, KDDATI3, KDDATI4, NOHP, "EMAIL", UPDSTAMP, INPUTER) SELECT TMT_ALM, TRIM(KDHUBKEL), TRIM(NOTAS), ALM_PESERTA, KOTA, KODEPOS, TELEPON, KDDATI1, KDDATI2, KDDATI3, KDDATI4,  NOHP, "EMAIL",UPDSTAMP, INPUTER FROM MIG_ACB.ALAMAT_HIST;
...
INSERT INTO TSPNMIG.TRS_HTG_TERLANJUR(NOTAS, KDHUBKEL, HUTANG, KDTRANS, KDJNSPENSIUN, POTKPKN_DIPOTONG, POTKPKN, POTKASDA_DIPOTONG, POTKASDA, SEWARMH_DIPOTONG, SEWARMH, TGLPROSES, FLOW_STS, KDCABANG, TGLKLAIM) SELECT TRIM(NOTAS), KDHUBKEL, HUTANG, KDTRANS, KDJNSPENSIUN, POTKPKN_DIPOTONG, POTKPKN, POTKASDA_DIPOTONG, POTKASDA, SEWARMH_DIPOTONG, SEWARMH, TGLPROSES, FLOW_STS, KDCABANG, TGLKLAIM FROM MIG_ACB.HUTANG_TERLANJUR A INNER JOIN TSPNMIG.PENERIMA_SK  AS B ON TRIM(A.KDHUBKEL) = TRIM(B.KDHUBKEL) AND TRIM(A.NOTAS) = TRIM(B.NOTAS);
...
INSERT INTO TSPNMIG.WORK_HUTANG_DETAIL(NOTAS, KDHUBKEL, TGLKLAIM, JENISHIT, TGLPROSES, KDTRANS, NILAI, UPDSTAMP, INPUTER) SELECT TRIM(A.NOTAS), A.KDHUBKEL, A.TGLKLAIM, JENISHIT, TGLPROSES, KDTRANS, NILAI, A.UPDSTAMP, A.INPUTER FROM MIG_ACB.WORK_HUTANG_DETAIL AS A INNER JOIN TSPNMIG.KLAIM_HUTANG ON A.TGLKLAIM=B.TGLKLAIM AND A.KDHUBKEL=B.KDHUBKEL AND TRIM(A.NOTAS) = B.NOTAS;
