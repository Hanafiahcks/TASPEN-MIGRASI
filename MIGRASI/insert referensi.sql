...
INSERT INTO TSPNMIG.REF_SANTUNAN_CACAT(KDCACAT, DESCRIPTION, PROSENTASE, JNSCACAT, INPUTER, UPDSTAMP) SELECT KDCACAT, DESCRIPTION, PROSENTASE, JNSCACAT,CURRENT_DATE,'MIGRASI NCB' FROM MIG_ACB.SANTUNAN_CACAT;
...
INSERT INTO TSPNMIG.REF_FORMKLIM(KDPRODUK, KDKLAIM, URAIAN, NORUT, UPDSTAMP, INPUTER, ISMANDATORY) SELECT KDPRODUK, KDKLAIM, URAIAN, NORUT, CURRENT_DATE,'MIGRASI NCB',TRUE FROM MIG_ACB.FORMKLIM;
