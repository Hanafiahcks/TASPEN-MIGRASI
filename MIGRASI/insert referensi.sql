...
UPSERT      TSPNMIG.REF_APLIKASI(KDAPL, NMAPL, INPUTER, UPDSTAMP) SELECT KDAPL, NMAPL,'MIGRASI NCB',CURRENT_DATE FROM MIG_ACB.APLIKASI;
...
UPSERT      TSPNMIG.REF_FUNGSI(KDFUNGSI, KDAPL, NMFUNGSI, UPDSTAMP, INPUTER) SELECT KDFUNGSI, KDAPL, NMFUNGSI, CURRENT_DATE,'MIGRASI NCB' FROM MIG_ACB.FUNGSI;
        --- LEVEL 2
UPSERT      TSPNMIG.REF_RUMAH_SAKIT SELECT * FROM MIGACB.REF_RUMAH_SAKIT;
UPSERT      TSPNMIG.REF_FAKTOR(TMT_FAKTOR, TAHUN_MI, KDKELOMPOK, MASAIURAN, NILAI, NILAI1, UPDSTAMP, KDPRODUK, NILAI2, INPUTER) SELECT TMT_FAKTOR, TAHUN_MI, KDKELOMPOK, MASAIURAN, NILAI, NILAI1, UPDSTAMP, KDPRODUK, NILAI2, 'MIGRASI NCB' FROM MIG_ACB.FAKTOR_TBL;
UPSERT      TSPNMIG.REF_FORMULAKLIM(TMT_FORMULA, KDYMKKEJADIAN, KDKELJADIAN, KDKLAIM, KDPRODUK, KDKELOMPOK, KOOFISIEN1, KOOFISIEN2, ASKEM, FAKTOR1, FAKTOR2, MANFAAT_MINIMAL, ASKEM_MINIMAL, URAIAN_FORMULA, KETERANGAN, UPDSTAMP, INPUTER) SELECT TMT_FORMULA, KDKEJADIAN, KDKELJADIAN, KDKLAIM, KDPRODUK, KDKELOMPOK, KOOFISIEN1, KOOFISIEN2, ASKEM, FAKTOR1, FAKTOR2, MANFAAT_MINIMAL, ASKEM_MINIMAL, URAIAN_FORMULA, KETERANGAN, UPDSTAMP, 'MIGRASI NCB' FROM MIG_ACB.FORMULA_KLIM;
UPSERT      TSPNMIG.REF_FUNGSI(KDFUNGSI, KDAPL, NMFUNGSI, UPDSTAMP, INPUTER) SELECT KDFUNGSI, KDAPL, NMFUNGSI, CURRENT_DATE,'MIGRASI NCB' FROM MIG_ACB.FUNGSI;
UPSERT      TSPNMIG.REF_HAKUDW(TMT_HAKUDW, KDJNSPENERIMA, KDKELOMPOK, NILAI_UDW, UPDSTAMP, INPUTER) SELECT TMT_HAKUDW, KDJNSPENERIMA, KDKELOMPOK, NILAI_UDW, UPDSTAMP, 'MIGRASI NCB' FROM MIG_ACB.HAKUDW_TBL;
UPSERT      TSPNMIG.REF_JNSSETORPAJAK(MAP, JENIS_SETORAN, JNS_PAJAK, DESKRIPSI, UPDSTAMP, INPUTER) SELECT MAP, JENIS_SETORAN, JNS_PAJAK, DESKRIPSI, CURRENT_DATE,'MIGRASI NCB' FROM MIG_ACB.JNS_SETOR_PAJAK;
UPSERT      TSPNMIG.REF_JURU_BAYAR(KDKANBYR, JNSBAYAR, KDGROUP, KDBENDAHARA, KDCABANG, NMKANBYR, ALM_JRBYR, KODEPOS, TELEPON, KDDATI2, KDDATI1, UPDSTAMP, INPUTER, NOURUT, KDBACKUPDPM, KDCEKPOS, KDKELBAYAR, KODE, KDJURUBAYAR, KDKPKN, STATUS) SELECT KDKANBYR, JNSBAYAR, KDGROUP, KDBENDAHARA, KDCABANG, NMKANBYR, ALM_JRBYR, KODEPOS, TELEPON, KDDATI2, KDDATI1, UPDSTAMP, INPUTER, NOURUT, KDBACKUPDPM, KDCEKPOS, KDKELBAYAR, KODE, KDJURUBAYAR, KDKPKN, STATUS FROM MIG_ACB.JURU_BAYAR;
UPSERT      TSPNMIG.REF_KONV_PENSIUN(KDJNSPENSIUN, KETERANGAN, KDJNSHAK, KDKELOMPOK, KDSUBKELPOK, KDKELPENSIUN, KDJNSPENERIMA, SHARINGDANA, UPDSTAMP, KDPTKAI, INPUTER) SELECT KDJNSPENSIUN, KETERANGAN, KDJNSHAK, KDKELOMPOK, KDSUBKELPOK, KDKELPENSIUN, KDJNSPENERIMA, SHARINGDANA, UPDSTAMP, KDPTKAI, 'MIGRASI NCB' FROM MIG_ACB.KONV_PENSIUN;
UPSERT      TSPNMIG.REF_KTRBYR_SETOR(NOKTRSETOR, TGLKTRSETOR, KDKANBYR, JNSBAYAR, KDGROUP, KDBENDAHARA, KDCABANG, UPDSTAMP, INPUTER) SELECT NOKTRSETOR, TGLKTRSETOR, KDKANBYR, JNSBAYAR, KDGROUP, KDBENDAHARA, KDCABANG, UPDSTAMP, INPUTER FROM MIG_ACB.KTRBYR_SETOR;
UPSERT      TSPNMIG.REF_MINIMAL_HAK(KDKELOMPOK, KDPRODUK, KDKLAIM, TMT_BERLAKU, NILAI, UPDSTAMP, INPUTER) SELECT KDKELOMPOK, KDPRODUK, KDKLAIM, TMT_BERLAKU, NILAI, CURRENT_DATE,'MIGRASI NCB' FROM MIG_ACB.MINIMAL_HAK;
UPSERT      TSPNMIG.REF_PANGKAT(KDPANGKAT, KDKELOMPOK, NMPANGKAT, NMSHORT, KDKONV, UPDSTAMP, INPUTER) SELECT KDPANGKAT, KDKELOMPOK, NMPANGKAT, NMSHORT, KDKONV, UPDSTAMP,'MIGRASI NCB' FROM MIG_ACB.PANGKAT_TBL;
UPSERT      TSPNMIG.REF_PENPOK(MASKER, JMLANAK, TMT_PENPOK, KDJNSPENERIMA, KDPANGKAT, KDKELOMPOK, KDSIFATPOK, PENPOK, UPDSTAMP, MASKER_LAST, INPUTER) SELECT MASKER, JMLANAK, TMT_PENPOK, KDJNSPENERIMA, KDPANGKAT, KDKELOMPOK, KDSIFATPOK, PENPOK, UPDSTAMP, MASKER_LAST, 'MIGRASI NCB' FROM MIG_ACB.PENPOK_TBL;
UPSERT      TSPNMIG.REF_SSBP(KDCABANG, KELSSBP, KDKPKN, KDSSBP, NMSSBP, KDDATI1, KDDATI2, KDKELOMPOK, NEWCUST, OLDCUST_ASS, OLDCUST_PENS, ID_ASS, ID_PENS, FLAG, TMTBERLAKU, ID_JKK, ID_JKM, UPDSTAMP, INPUTER) SELECT KDCABANG, KELSSBP, KDKPKN, KDSSBP, NMSSBP, KDDATI1, KDDATI2, KDKELOMPOK, NEWCUST, OLDCUST_ASS, OLDCUST_PENS, ID_ASS, ID_PENS, FLAG, TMTBERLAKU, ID_JKK, ID_JKM, UPDSTAMP, INPUTER FROM MIG_ACB.SSBP_TBL WHERE NMSSBP IS NOT NULL;
UPSERT      TSPNMIG.REF_GAPOK(MASKER, TMT_GAPOK, KDPANGKAT, KDKELOMPOK, NILAI_BAWAH, NILAI_ATAS, UPDSTAMP, INPUTER) SELECT MASKER, TMT_GAPOK, KDPANGKAT, KDKELOMPOK, NILAI_BAWAH, NILAI_ATAS, UPDSTAMP, 'MIGRASI NCB' FROM MIG_ACB.GAPOK_TBL;
UPSERT      TSPNMIG.REF_SKPD(KDCABANG, KDSSBP, KDSKPD, NMSKPD, UPDSTAMP, INPUTER, KELSSBP) SELECT A.KDCABANG, A.KDSSBP, A.KDSKPD, A.NMSKPD, A.UPDSTAMP, A.INPUTER, A.KELSSBP FROM MIG_ACB.SKPD_TBL  A inner join TSPNMIG.REF_SSBP b on a.KDCABANG = b.KDCABANG and a.KELSSBP = b.KELSSBP and a.KDSSBP = b.KDSSBP;
UPSERT      TSPNMIG.REF_SATKER(KDSATKER, KDBAG, KDBIRO, KDDIRJEN, KDINSTANSI, KDDATI4, KDDATI3, KDDATI2, KDDATI1, NMSATKER, KDKPKN, ALAMAT, NOTELP, UPDSTAMP, KDCABANG, INPUTER, KDSKPD, KDSSBP, SATKERPEMDA, KELSSBP) SELECT KDSATKER, KDBAG, KDBIRO, KDDIRJEN, KDINSTANSI, KDDATI4, KDDATI3, KDDATI2, KDDATI1, NMSATKER, KDKPKN, ALAMAT, NOTELP, A.UPDSTAMP, A.KDCABANG, A.INPUTER, A.KDSKPD, A.KDSSBP, A.SATKERPEMDA, A.KELSSBP FROM MIG_ACB.SATKER_TBL as A INNER JOIN TSPNMIG.REF_SKPD B ON
A.KDCABANG = B.KDCABANG AND  
A.KDSSBP   = B.KDSSBP   AND
A.KDSKPD   = B.KDSKPD   AND
A.KELSSBP  = B.KELSSBP ;

UPSERT TSPNMIG.REF_DATI4 (KDDATI4, KDDATI3, KDDATI2, KDDATI1, NMDATI4, UPDSTAMP)
...
UPSERT TSPNMIG.REF_DANA(KDCABANG, KDPRODUK, KDVOUCHER, KDDANA, NMDANA, STATUS, UPDSTAMP, INPUTER)
