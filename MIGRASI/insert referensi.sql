...
INSERT INTO TSPNMIG.REF_SKEP(NOSKEP, TGLSKEP, STSSKEP, KDSKPO, TMTSKEP, TMTREKAM, KDJNSSKEP, KDPENSKEP, TGLTERIMA, UPDSTAMP, INPUTER) SELECT NOSKEP, TGLSKEP, STSSKEP, KDSKPO, TMTSKEP, TMTREKAM, KDJNSSKEP, KDPENSKEP, TGLTERIMA, UPDSTAMP, INPUTER FROM MIG_ACB.SKEP;
...
SELECT KDDATI4, KDDATI3, KDDATI2, KDDATI1, NMDATI4, UPDSTAMP FROM
    (SELECT KDDATI4, A.KDDATI3, A.KDDATI2, A.KDDATI1, NMDATI4, A.UPDSTAMP, ROW_NUMBER() OVER (PARTITION BY KDDATI4, A.KDDATI3, A.KDDATI2, A.KDDATI1 ORDER BY A.UPDSTAMP DESC) AS row_num FROM MIG_ACB.DATI4_TBL A INNER JOIN REF_DATI3 B ON A.KDDATI3 = B.KDDATI3 AND A.KDDATI2 = B.KDDATI2 ANDA.KDDATI1 = B.KDDATI1 )
WHERE ROW_NUM =1;
